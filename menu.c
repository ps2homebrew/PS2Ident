...
static struct UIMenu BoardReportMenu   = {NULL, &Board2ReportMenu, BoardMenuItems, {{BUTTON_TYPE_START, SYS_UI_LBL_DUMP}, {BUTTON_TYPE_SYS_CANCEL, SYS_UI_LBL_QUIT}}};
